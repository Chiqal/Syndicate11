...
import CHIQAL
import requests
from CHIQAL.lib.curve.ttypes import *
    ...
    try:
        if op.param1 in wait2['readPoint']:
            ...
            if Name in wait2['readMember'][op.param1]:
                ...
                wait2['ROM'][op.param1][op.param2] = "Ñ1§79Ñ1§79" + Name
        else:
            pass
    except:
        pass
...
def bot(op):
    try:
        ...
        if op.type == 17:
            if op.param2 not in Bots:
                joinblacklist = op.param2.replace("Ñ1§7Ñ1§7",',')
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("client Kick regulation or Because it does not exist in the groupÑ1§7Ñ1§7\n["+op.param1+"]\nÑ1§7Ñ1§7\n["+op.param2+"]\nÑ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7°ËÑ1§7Ñ1§7Å0°0Ñ1§7Ñ1§7Å1™0Ñ1§7Ñ1§7Ñ1§7Å0°0Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7\nÑ1§7Å0Ù9Ñ1§7Å0ä2Ñ1§7Ñ1§7Ç7é8Ñ1§7Å0ß3Ñ1§7Å0˝1Ñ1§7Å0·6Ñ1§7Ñ1§7Å1™0Ñ1§7Ñ1§7Ñ1§7")
                ...
                if Amid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("clientÑ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Å0Ÿ0Ñ1§7Ñ1§7orÑ1§7Ñ1§7Ñ1§7Ñ1§7`Ñ1§7Å0˚2Å0ª4Ñ1§7Ñ1§7Å1ê4Ñ1§7Ñ1§7Å0≥9Ñ1§7Ñ1§7Óî\n["+op.param1+"]\nÑ1§7Ñ1§7\n["+op.param2+"]\nÑ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7°ËÑ1§7Ñ1§7Å0°0Ñ1§7Ñ1§7Å1™0Ñ1§7Ñ1§7Ñ1§7Å0°0Ñ1§7Ñ1§7Ñ1§7Ñ1§7Ñ1§7\nÑ1§7Å0Ù9Ñ1§7Å0ä2Ñ1§7Ñ1§7Ç7é8Ñ1§7Å0ß3Ñ1§7Å0˝1Ñ1§7Å0·6Ñ1§7Ñ1§7Å1™0Ñ1§7Ñ1§7Ñ1§7")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
               ...
               if wait["wblack"] == True:
                ...
                if wait["timeline"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        msg.text = "URLÑ1§70Ñ1§79Ñ1§76Ñ1§79Ñ1§7Ñ1§7\n" + msg.contentMetadata["postEndUrl"]
				...
				if msg.from_ in admin:
					...
					msg.text = None
					cl.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚Ñ1§7∫√£¬Å¬Æ√£∆í‚Ñ1§7î√£∆í¬¨√£‚Ñ1§7ö¬º√£∆í¬≥√£∆íÀÑ1§7","Bot1 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					ki.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚Ñ1§7∫√£¬Å¬Æ√£∆í‚Ñ1§7î√£∆í¬¨√£‚Ñ1§7ö¬º√£∆í¬≥√£∆íÀÑ1§7","Bot2 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kk.sendMessage(msg)
            elif msg.text in ["√¶‚Äû‚Ñ1§7∫√£¬Å¬Æ√£∆í‚Ñ1§7î√£∆í¬¨√£‚Ñ1§7ö¬º√£∆í¬≥√£∆íÀÑ1§7","Bot3 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"°∏ Mayhem\nMayhem is STARTINGÅ7¨8\n' abort' to abortÅ7¨8")
                    ki.sendText(msg.to,"°∏ Mayhem °π\n46 victims shall yell hul°§la°§ba°§looÅ7¨8\n/Å0∑5hÅ0¨5lÅ0¨5bÅ0¨5Å0∑4loÅ0∆0o,Å0∑4hÅ0¨5lÅ0¨5bÅ0¨5Å0∑5loÅ0∆0o/")
                    targets = []
                    for g in gs.members:
				...
				if msg.from_ in admin:
					if wait["blacklist"] == {}:
						...
						for mi_d in wait["blacklist"]:
							mc += "Ñ1§7" +cl.getContact(mi_d).displayName + "\n"
						cl.sendText(msg.to,mc)
